<nav x-data="{ open: false }" style="height: 0;">
    <!-- Primary Navigation Menu -->
    <div class="">
        <div class="">
            <div class="" style="padding: 0; margin: 0; height: 0;">
                <!-- Teams Dropdown -->
                        ...
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md active:bg-gray-50 transition ease-in-out duration-150">
