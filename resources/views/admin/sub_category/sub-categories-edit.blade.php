                        ...
                        <div class="custom-tabs-container">
                            ...
                            <div class="tab-content" id="formsTabContent">
                                ...
                                <div class="tab-pane fade show active" id="sub-category" role="tabpanel">
                                    <form action="" method="post" id="updateSubCategoryForm" name="updateSubCategoryForm">
                                        @csrf
                                        <!-- Row start -->
                                        <div class="row gx-3">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-8 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="sub-category-name" name="name" placeholder="Name" autocomplete="off" value="{{$subCategory->name}}">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-4 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" readonly style="background-color: #C0C0C0;" class="form-control" id="sub-category-slug" name="slug" placeholder="slug" value="{{$subCategory->slug}}">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
