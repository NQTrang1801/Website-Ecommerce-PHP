...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item breadcrumb-active" aria-current="Promotions"><a href="{{route('promotions.index')}}">Promotions</a>/Edit</li>
</ol>
@endsection
@section('content')
                        ...
                        <div class="custom-tabs-container">
                            <ul class="nav nav-tabs" id="formsTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="promotion-tab" data-bs-toggle="tab" href="#promotion" role="tab" aria-controls="categry" aria-selected="true">ID: {{$promotion->id}}</a>
                                </li>
                            </ul>
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-8 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="promotion-name" name="name" value="{{$promotion->name}}" placeholder="Name" autocomplete="off">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-4 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" readonly style="background-color: #C0C0C0;" class="form-control" id="promotion-slug" name="slug" value="{{$promotion->slug}}" placeholder="slug">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-8 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="promotion-code" name="code" placeholder="Code" value="{{$promotion->code}}" autocomplete="off">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-8 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="promotion-value" name="value" placeholder="Value" value="{{$promotion->value}}" autocomplete="off">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-8 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Value</label>
                                                    <div class="input-group">
                                                        <input type="date" class="form-control" id="promotion-date" name="expiration_date" value="{{$promotion->expiration_date}}" autocomplete="off">
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mt-2">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="status" id="StatusRadio1" value="1" {{($promotion->status == 1) ? 'checked' : ''}}>
                                                            <label class="form-check-label" for="StatusRadio1">Active</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="status" id="StatusRadio2" value="0" {{($promotion->status == 0) ? 'checked' : ''}}>
